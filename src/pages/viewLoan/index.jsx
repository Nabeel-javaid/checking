                  ...
                  >
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            style={{visibility: isLargeScreen ? "visible" : "hidden",}}
                          />
                        </div>
                        <p
                          style={{
                    ...
                    <div
                      ...
                      style={{
                        ...
                        padding: "22px",
                        fontWeight: "bold",
                        marginBottom: isLargeScreen ? "0px": "24px",
                      }}
                    >
                      {data.Status}
                    </div>
...
//cancel loan function
  ...
  const renderLoanDetailsDialog = () => (
    ...
    >
      ...
      <DialogActions
        style={{ background: "#4f4f4f", justifyContent: "center" }}
      >
        <Button
        ...
        {selectedLoan?.Status === "Paying Market" &&
        ...
        {selectedLoan?.BorrowerAddress === currentAccountAddress &&
          (selectedLoan?.Status.toLowerCase() === "accepted" ||
            selectedLoan?.Status.includes("% Repaid")) && (
            <>
              <Repay
  ...
  {/* code for normal page when it is loaded */}
    ...
    <Layout>
      {marketDetails && !marketDetails.isClosed ? (
        <>
          ...
          <Box 
          pt={isLargeScreen ? undefined: "6rem"}
         
        >
            <Typography
              variant="h3"
              marginTop={isLargeScreen ? "0px" : "50px"}
              style={{ color: "black", textAlign: "center",fontSize: isLargeScreen ? "3rem": "1.5rem" }}
            >
            ...
            <div className="feature section">
              <div className="container">
                ...
                <div
                  ...
                  style={{ position: "absolute", right: "45%", bottom: "7%" }}
                >
                  {totalPages > 1 && (
                    <Pagination
                      count={totalPages}
